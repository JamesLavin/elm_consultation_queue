...
Elm.ElmConsultQueue = Elm.ElmConsultQueue || {};
Elm.ElmConsultQueue.make = function (_elm) {
   "use strict";
   _elm.ElmConsultQueue = _elm.ElmConsultQueue || {};
   if (_elm.ElmConsultQueue.values) return _elm.ElmConsultQueue.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var checkbox = F4(function (address,isChecked,tag,name) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"},{ctor: "_Tuple2",_0: "margin-right",_1: "8px"}]))]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("checkbox")
                      ,$Html$Attributes.checked(isChecked)
                      ,A3($Html$Events.on,"change",$Html$Events.targetChecked,function (_p0) {    return A2($Signal.message,address,tag(_p0));})]),
              _U.list([]))
              ,$Html.text(name)]));
   });
   var teladocHeadline = A2($Html.div,
   _U.list([$Html$Attributes.$class("header")]),
   _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Super Amazingly Awesome Teladoc Consultation Queue Built With Elm")]))]));
   var noJavascript = A2($Html.h2,
   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "right"},{ctor: "_Tuple2",_0: "margin-right",_1: "10px"}]))]),
   _U.list([$Html.text("Look, Mom! No Javascript!")]));
   var teladocImg = A2($Html.img,
   _U.list([$Html$Attributes.src("Teladoc_logo.jpg")
           ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "150px"},{ctor: "_Tuple2",_0: "height",_1: "150px"}]))]),
   _U.list([]));
   var filteredConsultations = F2(function (model,status) {
      var statusFilteredConsults = A2($List.filter,function (consult) {    return _U.eq(consult.status,status);},model.consultations);
      var stateFilteredConsults = function () {
         var _p1 = model.filterState;
         if (_p1 === "") {
               return statusFilteredConsults;
            } else {
               return A2($List.filter,function (consult) {    return _U.eq(consult.state,model.filterState);},statusFilteredConsults);
            }
      }();
      var consults = function () {
         var _p2 = model.filterSpecialty;
         switch (_p2)
         {case "All": return stateFilteredConsults;
            case "General Medical": return A2($List.filter,
              function (consult) {
                 return _U.eq(consult.specialty,model.filterSpecialty);
              },
              stateFilteredConsults);
            case "Sexual Health": return A2($List.filter,function (consult) {    return _U.eq(consult.specialty,model.filterSpecialty);},stateFilteredConsults);
            case "Behavioral Health": return A2($List.filter,
              function (consult) {
                 return _U.eq(consult.specialty,model.filterSpecialty);
              },
              stateFilteredConsults);
            default: return stateFilteredConsults;}
      }();
      return consults;
   });
   var buttonText = function (consult) {
      return _U.eq(consult.status,"Completed") ? "" : _U.eq(consult.status,"Requested") ? "Lock" : _U.eq(consult.status,
      "Locked") ? "Complete" : _U.eq(consult.status,"Cancelled") ? "" : "";
   };
   var consultQueueStyle = function (model) {
      var width = function () {
         var _p3 = $List.length(model.displayedQueues);
         switch (_p3)
         {case 4: return "21%";
            case 3: return "28%";
            case 2: return "42%";
      ...
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: width}
                                            ,{ctor: "_Tuple2",_0: "display",_1: "inline-block"}
                                            ,{ctor: "_Tuple2",_0: "margin",_1: "1%"}
                                            ,{ctor: "_Tuple2",_0: "vertical-align",_1: "text-top"}]));
   };
   var completedConsultStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "backgroundColor",_1: "blanchedalmond"}
                                                              ,{ctor: "_Tuple2",_0: "margin",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "width",_1: "100%"}
                                                              ,{ctor: "_Tuple2",_0: "padding",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "border-style",_1: "solid"}]));
   var lockedConsultStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "backgroundColor",_1: "mistyrose"}
                                                           ,{ctor: "_Tuple2",_0: "color",_1: "darkred"}
                                                           ,{ctor: "_Tuple2",_0: "margin",_1: "5px"}
                                                           ,{ctor: "_Tuple2",_0: "width",_1: "100%"}
                                                           ,{ctor: "_Tuple2",_0: "padding",_1: "5px"}
                                                           ,{ctor: "_Tuple2",_0: "border-style",_1: "solid"}]));
   var cancelledConsultStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "backgroundColor",_1: "palegreen"}
                                                              ,{ctor: "_Tuple2",_0: "color",_1: "green"}
                                                              ,{ctor: "_Tuple2",_0: "width",_1: "100%"}
                                                              ,{ctor: "_Tuple2",_0: "margin",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "padding",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "border-style",_1: "solid"}]));
   var requestedConsultStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "backgroundColor",_1: "paleturquoise"}
                                                              ,{ctor: "_Tuple2",_0: "color",_1: "purple"}
                                                              ,{ctor: "_Tuple2",_0: "width",_1: "100%"}
                                                              ,{ctor: "_Tuple2",_0: "margin",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "padding",_1: "5px"}
                                                              ,{ctor: "_Tuple2",_0: "border-style",_1: "solid"}]));
   var consultStyle = function (consult) {
      return _U.eq(consult.status,"Completed") ? completedConsultStyle : _U.eq(consult.status,"Requested") ? requestedConsultStyle : _U.eq(consult.status,
      "Locked") ? lockedConsultStyle : _U.eq(consult.status,"Cancelled") ? cancelledConsultStyle : lockedConsultStyle;
   };
   var process_new_event = F2(function (event,model) {
      var _p4 = event.action;
      if (_p4 === "CREATE_CONSULTATION") {
            return _U.update(model,{consultations: A2($List._op["::"],event.payload,model.consultations)});
         } else {
            return model;
         }
   });
   var randInt = A2($Random.$int,1,10000);
   var specialtiesList = _U.list(["Behavioral Health","General Medical","Sexual Health"]);
   var removeDisplayCompleted = function (model) {
      return A2($List.member,"Completed",model.displayedQueues) ? _U.update(model,
      {displayCompleted: false
      ,displayedQueues: A2($List.filter,function (displayedQueue) {    return !_U.eq(displayedQueue,"Completed");},model.displayedQueues)}) : _U.update(model,
      {displayCompleted: true});
   };
   var addDisplayCompleted = function (model) {
      return A2($List.member,"Completed",model.displayedQueues) ? _U.update(model,{displayCompleted: true}) : _U.update(model,
      {displayCompleted: true,displayedQueues: A2($List.append,model.displayedQueues,_U.list(["Completed"]))});
   };
   var setDisplayCompleted = F2(function (model,$boolean) {    return $boolean ? addDisplayCompleted(model) : removeDisplayCompleted(model);});
   var removeDisplayCancelled = function (model) {
      return A2($List.member,"Cancelled",model.displayedQueues) ? _U.update(model,
      {displayCancelled: false
      ,displayedQueues: A2($List.filter,function (displayedQueue) {    return !_U.eq(displayedQueue,"Cancelled");},model.displayedQueues)}) : _U.update(model,
      {displayCancelled: true});
   };
   var addDisplayCancelled = function (model) {
      return A2($List.member,"Cancelled",model.displayedQueues) ? _U.update(model,{displayCancelled: true}) : _U.update(model,
      {displayCancelled: true,displayedQueues: A2($List._op["::"],"Cancelled",model.displayedQueues)});
   };
   var setDisplayCancelled = F2(function (model,$boolean) {    return $boolean ? addDisplayCancelled(model) : removeDisplayCancelled(model);});
   var LockConsultationPayload = F2(function (a,b) {    return {id: a,provider_id: b};});
   var Complete = function (a) {    return {ctor: "Complete",_0: a};};
   var Lock = function (a) {    return {ctor: "Lock",_0: a};};
   var NewEvent = function (a) {    return {ctor: "NewEvent",_0: a};};
   var FilterState = function (a) {    return {ctor: "FilterState",_0: a};};
   var stateBox = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"},{ctor: "_Tuple2",_0: "margin-right",_1: "8px"}]))]),
      _U.list([A2($Html.p,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"},{ctor: "_Tuple2",_0: "margin-right",_1: "8px"}]))]),
              _U.list([$Html.text("Filter by state: ")]))
              ,A2($Html.input,
              _U.list([$Html$Attributes.type$("string")
                      ,$Html$Attributes.placeholder("")
                      ,$Html$Attributes.name("State")
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (v) {    return A2($Signal.message,address,FilterState(v));})
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"}]))]),
              _U.list([]))]));
   };
   var DisplayCompleted = function (a) {    return {ctor: "DisplayCompleted",_0: a};};
   var DisplayCancelled = function (a) {    return {ctor: "DisplayCancelled",_0: a};};
   var Specialty = function (a) {    return {ctor: "Specialty",_0: a};};
   var specialtiesDropDown = F2(function (address,model) {
      var selectEvent = A3($Html$Events.on,"change",$Html$Events.targetValue,function (_p5) {    return A2($Signal.message,address,Specialty(_p5));});
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"},{ctor: "_Tuple2",_0: "margin-right",_1: "8px"}]))]),
      ...
      A2($List.map,
      function (specialty) {
         return A2($Html.option,_U.list([$Html$Attributes.value(specialty)]),_U.list([$Html.text(specialty)]));
      },
      A2($List._op["::"],"All",specialtiesList)))]));
   });
   var AddConsultation = {ctor: "AddConsultation"};
   var addConsultationTicker = A2($Signal.map,function (_p6) {    return AddConsultation;},$Time.every(5 * $Time.second));
   var NoOp = {ctor: "NoOp"};
   var inbox = $Signal.mailbox(NoOp);
   var allActions = $Signal.mergeMany(_U.list([inbox.signal,addConsultationTicker]));
   var buttonAction = function (consult) {
      return _U.eq(consult.status,"Completed") ? NoOp : _U.eq(consult.status,"Requested") ? Lock(consult) : _U.eq(consult.status,
      "Locked") ? Complete(consult) : _U.eq(consult.status,"Cancelled") ? NoOp : NoOp;
   };
   var showConsultation = F2(function (address,consult) {
      return A2($Html.div,
      _U.list([consultStyle(consult)]),
      _U.list([A2($Html.span,
      _U.list([$Html$Attributes.$class("consultation")]),
      _U.list([A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Consultation ID: ",
              A2($Basics._op["++"],$Basics.toString(consult.id),A2($Basics._op["++"]," / State: ",consult.state))))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Status: ",
              A2($Basics._op["++"],consult.status,A2($Basics._op["++"]," / Specialty: ",consult.specialty))))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Member: ",
              A2($Basics._op["++"],consult.member_name,A2($Basics._op["++"]," (ID: ",A2($Basics._op["++"],$Basics.toString(consult.member_id),")")))))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([!_U.eq(consult.status,"Completed") && !_U.eq(consult.status,"Cancelled") ? A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,buttonAction(consult))]),
              _U.list([$Html.text(buttonText(consult))])) : A2($Html.br,_U.list([]),_U.list([]))]))]))]));
   });
   var showAllConsultations = F2(function (address,model) {    return A2($List.map,showConsultation(address),model.consultations);});
   var showFilteredConsultations = F3(function (address,model,status) {
      return A2($List.map,showConsultation(address),A2(filteredConsultations,model,status));
   });
   var requestedConsultSpan = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("consultations"),consultQueueStyle(model)]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("REQUESTED")])),A2($Html.div,_U.list([]),A3(showFilteredConsultations,address,model,"Requested"))]));
   });
   var lockedConsultSpan = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("consultations"),consultQueueStyle(model)]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("LOCKED")])),A2($Html.div,_U.list([]),A3(showFilteredConsultations,address,model,"Locked"))]));
   });
   var cancelledConsultSpan = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("consultations"),consultQueueStyle(model)]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("CANCELLED")])),A2($Html.div,_U.list([]),A3(showFilteredConsultations,address,model,"Cancelled"))]));
   });
   var completedConsultSpan = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("consultations"),consultQueueStyle(model)]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("COMPLETED")])),A2($Html.div,_U.list([]),A3(showFilteredConsultations,address,model,"Completed"))]));
   });
   var classConsultSpan = F3(function (address,model,$class) {
      var _p7 = $class;
      switch (_p7)
      {case "Requested": return A2(requestedConsultSpan,address,model);
         case "Locked": return A2(lockedConsultSpan,address,model);
         case "Cancelled": return A2(cancelledConsultSpan,address,model);
         case "Completed": return A2(completedConsultSpan,address,model);
         default: return A2(completedConsultSpan,address,model);}
   });
   var teladocConsultationQueues = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.div,_U.list([]),A2($List.map,A2(classConsultSpan,address,model),model.displayedQueues))]));
   });
   var view = F2(function (address,model) {
      ...
      _U.list([teladocImg
              ,noJavascript
              ,teladocHeadline
              ,A4(checkbox,address,model.displayCancelled,DisplayCancelled,"Display cancelled?")
              ,A4(checkbox,address,model.displayCompleted,DisplayCompleted,"Display completed?")
              ,A2(specialtiesDropDown,address,model)
              ,stateBox(address)
              ,A2(teladocConsultationQueues,address,model)]));
   });
   var lastNames = _U.list(["McDougle","Brownstein","Milgrom","French","O\'Connell","Smith","Skywalker","Parker","Carver","Singh"]);
   var firstNames = _U.list(["John","Mary","Pete","Stan","Rocky","Bulwinkle","Frosty","Casper","Ronald","Tom","Peter","Shiv"]);
   var randomMemberName = function ($int) {
      var secondInt = A2($Basics._op["%"],$int,$List.length(lastNames));
      var maybeLastName = $List.head(A2($List.drop,secondInt,lastNames));
      var firstInt = A2($Basics._op["%"],$int,$List.length(firstNames));
      var maybeFirstName = $List.head(A2($List.drop,firstInt,firstNames));
      var _p8 = {ctor: "_Tuple2",_0: maybeFirstName,_1: maybeLastName};
      if (_p8.ctor === "_Tuple2" && _p8._0.ctor === "Just" && _p8._1.ctor === "Just") {
            return A2($Basics._op["++"],_p8._0._0,A2($Basics._op["++"]," ",_p8._1._0));
         } else {
            return "";
         }
   };
   var randomSpecialty = function ($int) {
      var index = A2($Basics._op["%"],$int,$List.length(specialtiesList));
      var maybeSpecialty = $List.head(A2($List.drop,index,specialtiesList));
      var _p9 = maybeSpecialty;
      if (_p9.ctor === "Just") {
            return _p9._0;
         } else {
            return "";
   ...
   var statuses = _U.list(["Requested","Locked","Cancelled","Completed"]);
   var randomStatus = function ($int) {
      var index = A2($Basics._op["%"],$int,$List.length(statuses));
      var maybeStatus = $List.head(A2($List.drop,index,statuses));
      var _p10 = maybeStatus;
      if (_p10.ctor === "Just") {
            return _p10._0;
         } else {
            return "";
   ...
   var states = _U.list(["AL","AK","AS","CA","CT","FL","LA","NC","NM","NY","VA","VT"]);
   var randomState = function ($int) {
      var index = A2($Basics._op["%"],$int,$List.length(states));
      var maybeState = $List.head(A2($List.drop,index,states));
      var _p11 = maybeState;
      if (_p11.ctor === "Just") {
            return _p11._0;
         } else {
   ...
   var randomConsult = function ($int) {
      return {id: $int
   ...
   var update = F2(function (action,model) {
      var _p12 = action;
      switch (_p12.ctor)
      {case "NewEvent": return A2(process_new_event,_p12._0,model);
         case "AddConsultation": var _p13 = A2($Random.generate,randInt,model.seed);
           var value$ = _p13._0;
           var seed$ = _p13._1;
           var consultation = randomConsult(value$);
           return _U.update(model,{consultations: A2($List._op["::"],consultation,model.consultations),seed: seed$});
         case "Specialty": var _p14 = _p12._0;
           return _U.eq(_p14,"All") ? _U.update(model,{filterSpecialty: "All"}) : A2($List.member,_p14,specialtiesList) ? _U.update(model,
           {filterSpecialty: _p14}) : _U.update(model,{filterSpecialty: "All"});
         case "DisplayCancelled": return A2(setDisplayCancelled,model,_p12._0);
         case "DisplayCompleted": return A2(setDisplayCompleted,model,_p12._0);
         case "FilterState": return _U.update(model,{filterState: _p12._0});
         case "Lock": var this_consult_id = _p12._0.id;
           var convert_consultation = function (consultation) {
              return _U.eq(consultation.id,this_consult_id) ? _U.update(consultation,{status: "Locked"}) : consultation;
           };
           return _U.update(model,{consultations: A2($List.map,convert_consultation,model.consultations)});
         case "Complete": var this_consult_id = _p12._0.id;
           var convert_consultation = function (consultation) {
              return _U.eq(consultation.id,this_consult_id) ? _U.update(consultation,{status: "Completed"}) : consultation;
           };
           return _U.update(model,{consultations: A2($List.map,convert_consultation,model.consultations)});
         default: return model;}
   });
   var teladocRandomState = function (model) {
      return A2($Html.div,_U.list([]),_U.list([A2($Html.div,_U.list([]),_U.list([$Html.text(randomState(model.nextConsultId))]))]));
   };
   ...
   var initialConsultation6 = {id: 61,state: "FL",status: "Cancelled",specialty: "General Medical",member_id: 894,member_name: "Bruce Wayne"};
   var initialConsultation5 = {id: 320,state: "NC",status: "Locked",specialty: "General Medical",member_id: 204,member_name: "Clark Kent"};
   var initialConsultation4 = {id: 92,state: "LA",status: "Requested",specialty: "Sexual Health",member_id: 1032,member_name: "R2D2"};
   var initialConsultation3 = {id: 164,state: "NM",status: "Locked",specialty: "Behavioral Health",member_id: 924,member_name: "Darth Vader"};
   var initialConsultation2 = {id: 47,state: "NY",status: "Requested",specialty: "Sexual Health",member_id: 546,member_name: "Philip Vanderhoff"};
   var initialConsultation1 = {id: 31,state: "CA",status: "Completed",specialty: "General Medical",member_id: 23,member_name: "Stan Geldoff"};
   var consultationsList = _U.list([initialConsultation1
                                   ,initialConsultation2
                                   ,initialConsultation3
                                   ,initialConsultation4
                                   ,initialConsultation5
                                   ,initialConsultation6]);
   var initialModel = {consultations: consultationsList
                      ,providers: _U.list([])
                      ,members: _U.list([])
                      ,displayedQueues: _U.list(["Cancelled","Requested","Locked","Completed"])
                      ,displayCancelled: true
                      ,displayCompleted: true
                      ,filterState: ""
                      ,filterSpecialty: ""
   ...
   var modelSignal = A3($Signal.foldp,update,initialModel,allActions);
   var main = A2($Signal.map,view(inbox.address),modelSignal);
   var Consultation = F6(function (a,b,c,d,e,f) {    return {id: a,state: b,status: c,specialty: d,member_id: e,member_name: f};});
   var Member = F2(function (a,b) {    return {id: a,name: b};});
   var Provider = F4(function (a,b,c,d) {    return {id: a,name: b,state: c,specialty: d};});
   return _elm.ElmConsultQueue.values = {_op: _op
                                        ,Provider: Provider
                                        ,Member: Member
                                        ,Consultation: Consultation
                                        ,initialConsultation1: initialConsultation1
                                        ,initialConsultation2: initialConsultation2
                                        ,initialConsultation3: initialConsultation3
                                        ,initialConsultation4: initialConsultation4
                                        ,initialConsultation5: initialConsultation5
                                        ,initialConsultation6: initialConsultation6
                                        ...
                                        ,randomSpecialty: randomSpecialty
                                        ,firstNames: firstNames
                                        ,lastNames: lastNames
                                        ,randomMemberName: randomMemberName
                                        ,randomConsult: randomConsult
                                        ,NoOp: NoOp
                                        ...
                                        ,Lock: Lock
                                        ,Complete: Complete
                                        ,LockConsultationPayload: LockConsultationPayload
                                        ,addDisplayCancelled: addDisplayCancelled
                                        ,removeDisplayCancelled: removeDisplayCancelled
                                        ,setDisplayCancelled: setDisplayCancelled
                                        ,addDisplayCompleted: addDisplayCompleted
                                        ,removeDisplayCompleted: removeDisplayCompleted
                                        ,setDisplayCompleted: setDisplayCompleted
                                        ,specialtiesList: specialtiesList
                                        ,randInt: randInt
                                        ,update: update
                                        ,inbox: inbox
                                        ,process_new_event: process_new_event
                                        ,requestedConsultStyle: requestedConsultStyle
                                        ,cancelledConsultStyle: cancelledConsultStyle
                                        ,lockedConsultStyle: lockedConsultStyle
                                        ,completedConsultStyle: completedConsultStyle
                                        ,consultStyle: consultStyle
                                        ,consultQueueStyle: consultQueueStyle
                                        ,buttonText: buttonText
                                        ,buttonAction: buttonAction
                                        ,showConsultation: showConsultation
                                        ,addConsultationTicker: addConsultationTicker
                                        ,filteredConsultations: filteredConsultations
                                        ,showAllConsultations: showAllConsultations
                                        ,showFilteredConsultations: showFilteredConsultations
                                        ,teladocImg: teladocImg
                                        ,noJavascript: noJavascript
                                        ,teladocHeadline: teladocHeadline
                                        ,classConsultSpan: classConsultSpan
                                        ,requestedConsultSpan: requestedConsultSpan
                                        ,lockedConsultSpan: lockedConsultSpan
                                        ,cancelledConsultSpan: cancelledConsultSpan
                                        ,completedConsultSpan: completedConsultSpan
                                        ,teladocConsultationQueues: teladocConsultationQueues
                                        ,teladocRandomState: teladocRandomState
                                        ,checkbox: checkbox
                                        ,stateBox: stateBox
                                        ,specialtiesDropDown: specialtiesDropDown
                                        ,view: view
